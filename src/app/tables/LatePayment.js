                                    ...
                                    {late && late.map((item) => {
                                        ...
                                        return (
                                            <tr key={item.id}>
                                                ...
                                                <td>{(item.values?.category !== 'sales' && item.values?.category !== 'buys' && (item.values.name ? item.values?.name.charAt(0)+item.values?.name.slice(1).toLowerCase() : 'Faucet')) || 'Faucet'}</td>
